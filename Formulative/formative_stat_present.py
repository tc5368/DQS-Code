...
class FormativeStats(Frame):
    ...
    def searches(self):
        ...
        searchLabel = Label(self, text="Test ID:"+self.filename, font= "Helvetica 18 bold")
    ...
    def stats(self):
        ...
        data = Counter(sco)
        modal_score = data.most_common(1)
        modal_string = ""
        print(modal_score)
        for item in modal_score:
            for ch in item:
                modal_string = modal_string + " " + str(ch) + " "
       

        modal_label = Label(self, text="Modal Score:"+modal_string, font = "Helvetica 16").grid(row=3, column=1, sticky=W, padx=5, pady=5)
